    ...
    >
      ...
      >
        ...
        <span className="flex flex-col justify-center p-6 sm:p-10 lg:p-14">
          ...
          <span className="mt-8 inline-flex w-fit items-center gap-2 text-sm font-semibold underline decoration-primary/45 underline-offset-4 transition-colors group-hover:text-primary">
            {link.label}
            <ArrowUpRight
              aria-hidden="true"
